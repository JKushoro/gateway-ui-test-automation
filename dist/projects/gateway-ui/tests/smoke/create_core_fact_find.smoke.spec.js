...
const KycFactFindDetailsPageSteps_1 = require("@steps/kyc_forms/kyc_single_core_fact_find_forms/KycFactFindDetailsPageSteps");
const KycPersonalDetailsPageSteps_1 = require("@steps/kyc_forms/kyc_single_core_fact_find_forms/KycPersonalDetailsPageSteps");
const KycCurrentSituationPageSteps_1 = require("@steps/kyc_forms/kyc_single_core_fact_find_forms/KycCurrentSituationPageSteps");
const KycPropertyAndAssetsSteps_1 = require("@steps/kyc_forms/kyc_single_core_fact_find_forms/KycPropertyAndAssetsSteps");
const KycSavingsAndInvestmentsPageSteps_1 = require("@steps/kyc_forms/kyc_single_core_fact_find_forms/KycSavingsAndInvestmentsPageSteps");
const KycPensionsPageSteps_1 = require("@steps/kyc_forms/kyc_single_core_fact_find_forms/KycPensionsPageSteps");
const KycProtectionPageSteps_1 = require("@steps/kyc_forms/kyc_single_core_fact_find_forms/KycProtectionPageSteps");
const KycIncomePageSteps_1 = require("@steps/kyc_forms/kyc_single_core_fact_find_forms/KycIncomePageSteps");
const KycLiabilitiesAndExpendituresPageSteps_1 = require("@steps/kyc_forms/kyc_single_core_fact_find_forms/KycLiabilitiesAndExpendituresPageSteps");
const KycInvestmentKnowledgeAndPreferencesPageSteps_1 = require("@steps/kyc_forms/kyc_single_core_fact_find_forms/KycInvestmentKnowledgeAndPreferencesPageSteps");
