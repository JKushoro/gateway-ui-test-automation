...
const KycPersonalDetailsPageLocators_1 = require("@pages/kycElementLocators/kyc_core_fact_find_locators/KycPersonalDetailsPageLocators");
class KycPersonalDetailsPageSteps extends BaseKYCSteps_1.BaseKYCSteps {
    ...
    async verifyPersonalDetailsHeading() {
        ...
        await this.assert.assertHeadingVisible('Personal details', 15000);
    }
    // =====================================================
    ...
    async selectDependantOneRelationship(value) {
        ...
        (0, test_1.expect)(chosen, 'Should have selected a relationship option').toBeDefined();
        (0, test_1.expect)(chosen, 'Selected relationship should not be empty').not.toBe('');
        await (0, test_1.expect)(this.page.getByText(chosen, { exact: false }).first(), `Selected relationship "${chosen}" should be visible on page`).toBeVisible();
