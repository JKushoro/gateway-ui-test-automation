...
export declare class KycCurrentSituationPageSteps extends BaseKYCSteps {
     ...
     */
    validateCurrentSituationPage(): Promise<void>;
    /**
     ...
     */
    answerAllCurrentSituationQuestions(): Promise<void>;
    /**
     * 🎯 Handle employment-related questions
     */
    handleEmploymentQuestions(): Promise<void>;
    /**
     * 🎯 Handle retirement-related questions
     */
    handleRetirementQuestions(): Promise<void>;
    /**
     * 🎯 Handle health-related questions
     */
    handleHealthQuestions(): Promise<void>;
    /**
     * 🎯 Handle personal details questions and save the data
     */
    handlePersonalDetailsQuestions(): Promise<void>;
    /**
     * 🎯 Handle legal document questions
     */
    handleLegalDocumentQuestions(): Promise<void>;
    /**
