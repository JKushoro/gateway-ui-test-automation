...
export declare class KycPensionsPageSteps extends BaseKYCSteps {
     ...
     */
    answerAllPensionQuestions(): Promise<void>;
    /**
     ...
     */
    answerWorkplacePensionQuestion(answer?: string): Promise<void>;
    /**
     * Answer: "Do you have any pensions from previous employment?"
     * Uses the standardized radio question pattern with verification
     */
    answerPreviousEmploymentPensionsQuestion(answer?: string): Promise<void>;
    /**
     * Answer: "Do you have any other pensions?"
     * Uses the standardized radio question pattern with verification
     */
    answerOtherPensionsQuestion(answer?: string): Promise<void>;
    /**
     * Answer: "Have you requested a state pension forecast?"
     * Uses the standardized radio question pattern with verification
     */
    answerStatePensionForecastQuestion(answer?: string): Promise<void>;
}
