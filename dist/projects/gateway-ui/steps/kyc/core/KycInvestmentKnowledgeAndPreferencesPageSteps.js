...
const KycInvestmentKnowledgeAndPreferencesPageLocators_1 = require("@pages/kycElementLocators/kyc_core_fact_find_locators/KycInvestmentKnowledgeAndPreferencesPageLocators");
/**
...
class KycInvestmentKnowledgeAndPreferencesPageSteps extends BaseKYCSteps_1.BaseKYCSteps {
    ...
    async completeKYC_InvestmentKnowledgeAndPreferences() {
        ...
        await this.assert.assertHeadingVisible('Investment Knowledge & Preferences', 15000);
    ...
    async answerInvestmentKnowledgeAndPreferencesQuestions() {
        ...
        await this.answerSustainabilityRequirements('Yes – relating to one and/or some of my objectives');
    ...
    async answerSustainabilityAwareness(value) {
        ...
        const questionPattern = src_1.TextHelper.toRegExp(questionText);
    ...
    async assertResponsibleInvestmentFramework() {
        ...
        await (0, src_1.expect)(this.locators.responsibleInvestmentFrameworkTitle).toHaveText("Fairstone's Responsible Investment Framework", { timeout: 15000 });
        await (0, src_1.expect)(this.locators.negativeScreensHeading).toContainText('Negative Screens');
        await (0, src_1.expect)(this.locators.carbonReductionHeading).toContainText('Carbon Reduction');
        await (0, src_1.expect)(this.locators.positiveOutcomesHeading).toContainText('Positive Outcomes');
    }
    /**
