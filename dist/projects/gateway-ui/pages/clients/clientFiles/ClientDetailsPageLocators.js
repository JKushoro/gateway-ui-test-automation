...
exports.ClientDetailsPageLocators = void 0;
const src_1 = require("@/framework/src");
class ClientDetailsPageLocators extends src_1.BasePage {
    ...
    gatewayBsCell(sectionTitle, labelText) {
    ...
    summaryPanelCell(sectionTitle, labelText) {
    ...
    summaryPanelCellAlt(sectionTitle, labelText) {
        const panel = this.page
            .locator('div')
            .filter({ has: this.page.locator('h3,h4,h5', { hasText: sectionTitle }) })
            .first();
...
exports.ClientDetailsPageLocators = ClientDetailsPageLocators;
//# sourceMappingURL=ClientDetailsPageLocators.js.map