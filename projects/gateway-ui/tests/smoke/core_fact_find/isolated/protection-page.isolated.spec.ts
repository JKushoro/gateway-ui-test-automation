...
setupIsolatedTest('Core Fact Find - Protection Page (Isolated)', () => {
  test('Protection page - complete protection details (direct focus)', async ({ browser }) => {
    ...
    // Complete the Protection page
    const kycSteps = new KycProtectionPageSteps(kycPage);
    await kycSteps.completeKYC_Protection();
