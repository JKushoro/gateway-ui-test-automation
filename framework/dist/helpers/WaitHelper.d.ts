...
export declare class WaitHelper {
     ...
     */
    waitForMultipleConditions(conditions: (() => Promise<void>)[], timeout?: number): Promise<void>;
    /**
     * Wait for any of multiple conditions to be met
     */
    waitForAnyCondition(conditions: (() => Promise<void>)[], timeout?: number): Promise<void>;
    /**
     * Wait with retry logic
     */
    waitWithRetry(condition: () => Promise<boolean>, maxRetries?: number, retryDelay?: number, timeout?: number): Promise<void>;
    /**
